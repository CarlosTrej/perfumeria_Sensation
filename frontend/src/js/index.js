    ...
    if (isAdmin != null) {
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item dropdown">
              ...
              <a class="dropdown-item" href="./pages/products.html">
              <p class ="opcionesNavBar">Perfumes</p></a>
              </div>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#AcercaDeNosotros">¿Quienes somos?</a>
          </li>
          <li class="nav-item active">
      ...
      <ul class="nav-item active dropdown">
          ...
          <a class="nav-link"href="./pages/rowUpdateDelete.html" >
          ...
          <a class="nav-link"href="./pages/carritoCompras.html" >
    ...
    if (button.getAttribute('listener') !== 'true') {
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="./pages/products.html"><p class ="opcionesNavBar">Perfumes</p></a>
              </div>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#AcercaDeNosotros">¿Quienes somos?</a>
      ...
      <form class="form-inline my-2 my-lg-0">
          ...
          <ul class="nav-item active dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="./pages/logIn.html"><p class ="opcionesNavBar">Inicia sesión</p></a>
              <a class="dropdown-item" href="./pages/registro.html"><p class ="opcionesNavBar">Registro</p></a>
              </div>
          </ul>
      </form>
      </div>`;
